...
contract Lottery is Ownable {
    ...
    function getRandomNumber() public view returns (uint256 randomNumber) {
        ...
        randomNumber = uint256(previousBlockHash);

        // Modulus to limit the range of the random number
    ...
    function prizeWithdraw(uint256 amount) external {
        ...
        require(paymentToken.transfer(msg.sender, amount),
    ...
    function ownerWithdraw(uint256 amount) external onlyOwner {
        ...
        ownerPool -= amount;
        require(paymentToken.transfer(owner(), amount),
